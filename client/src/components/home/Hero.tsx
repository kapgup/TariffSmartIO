              ...
              <CardContent className="px-6 py-8">
                ...
                <div className="mt-6 relative">
                  ...
                  <div className="relative pl-8">
                    <div className="mb-8">
                      <div className="absolute left-4 -translate-x-1/2 w-4 h-4 rounded-full bg-primary/90 border-2 border-white shadow-md z-10"></div>
                    ...
                    <div className="mb-8">
                      <div className="absolute left-4 -translate-x-1/2 w-4 h-4 rounded-full bg-secondary/90 border-2 border-white shadow-md z-10"></div>
                    ...
                    <div>
                      <div className="absolute left-4 -translate-x-1/2 w-4 h-4 rounded-full bg-warning/90 border-2 border-white shadow-md z-10"></div>
